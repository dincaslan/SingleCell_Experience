...
``{r}
# Let's inspect the metadata as dataframe, based on this: https://hbctraining.github.io/scRNA-seq/lessons/04_SC_quality_control.html
...
# You have more space! Great, because you might want to save this one to avoid creating again and again: RData object to load at any time
saveRDS(DataAltogether, file="/YOUR/PATH/TO/DemultiplexeddDataset.rds") 
```
